...
/**
 * CaOccurrencesXVocabularyTerms
 *
 * @ORM\Table(name="ca_occurrences_x_vocabulary_terms", uniqueConstraints={@ORM\UniqueConstraint(name="u_all", columns={"occurrence_id", "type_id", "sdatetime", "edatetime", "item_id"})}, indexes={@ORM\Index(name="i_object_id", columns={"occurrence_id"}), @ORM\Index(name="i_label_left_id", columns={"label_left_id"}), @ORM\Index(name="i_item_id", columns={"item_id"}), @ORM\Index(name="i_label_right_id", columns={"label_right_id"}), @ORM\Index(name="i_type_id", columns={"type_id"})})
 * @ORM\Entity
 */
class CaOccurrencesXVocabularyTerms
{
    /**
     * @var int
     *
