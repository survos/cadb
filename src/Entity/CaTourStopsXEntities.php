...
/**
 * CaTourStopsXEntities
 *
 * @ORM\Table(name="ca_tour_stops_x_entities", uniqueConstraints={@ORM\UniqueConstraint(name="u_all", columns={"entity_id", "stop_id", "type_id", "sdatetime", "edatetime"})}, indexes={@ORM\Index(name="i_entity_id", columns={"entity_id"}), @ORM\Index(name="i_label_left_id", columns={"label_left_id"}), @ORM\Index(name="i_stop_id", columns={"stop_id"}), @ORM\Index(name="i_label_right_id", columns={"label_right_id"}), @ORM\Index(name="i_type_id", columns={"type_id"})})
 * @ORM\Entity
 */
class CaTourStopsXEntities
{
    /**
     * @var int
     *
