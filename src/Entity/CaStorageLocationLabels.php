...
/**
 * CaStorageLocationLabels
 *
 * @ORM\Table(name="ca_storage_location_labels", uniqueConstraints={@ORM\UniqueConstraint(name="u_all", columns={"location_id", "name", "locale_id", "type_id"})}, indexes={@ORM\Index(name="i_location_id", columns={"location_id"}), @ORM\Index(name="i_name_sort", columns={"name_sort"}), @ORM\Index(name="i_locale_id", columns={"locale_id"}), @ORM\Index(name="i_name", columns={"name"}), @ORM\Index(name="i_type_id", columns={"type_id"})})
 * @ORM\Entity
 */
class CaStorageLocationLabels
{
    /**
     * @var int
     *
