 ...
 * CaMovementLabels
 *
 * @ORM\Table(name="ca_movement_labels", indexes={@ORM\Index(name="i_type_id", columns={"type_id"}), @ORM\Index(name="i_movement_id", columns={"movement_id"}), @ORM\Index(name="i_name", columns={"name"}), @ORM\Index(name="i_locale_id_id", columns={"locale_id"}), @ORM\Index(name="i_name_sort", columns={"name_sort"})})
 * @ORM\Entity
 */
class CaMovementLabels
{
    /**
     * @var int
     *
