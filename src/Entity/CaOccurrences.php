 ...
 * CaOccurrences
 *
 * @ORM\Table(name="ca_occurrences", indexes={@ORM\Index(name="i_type_id", columns={"type_id"}), @ORM\Index(name="i_hier_right", columns={"hier_right"}), @ORM\Index(name="i_occ_filter", columns={"occurrence_id", "deleted", "access"}), @ORM\Index(name="i_submission_user_id", columns={"submission_user_id"}), @ORM\Index(name="i_submission_via_form", columns={"submission_via_form"}), @ORM\Index(name="i_parent_id", columns={"parent_id"}), @ORM\Index(name="i_locale_id", columns={"locale_id"}), @ORM\Index(name="i_hier_occurrence_id", columns={"hier_occurrence_id"}), @ORM\Index(name="i_submission_group_id", columns={"submission_group_id"}), @ORM\Index(name="i_source_id", columns={"source_id"}), @ORM\Index(name="i_hier_left", columns={"hier_left"}), @ORM\Index(name="i_view_count", columns={"view_count"}), @ORM\Index(name="i_submission_status_id", columns={"submission_status_id"})})
 * @ORM\Entity
 */
class CaOccurrences
{
     ...
     * @var int
     *
     * @ORM\Column(name="occurrence_id", type="integer", nullable=false, options={"unsigned"=true})
     * @ORM\Id
     ...
     * @var int
     *
     * @ORM\Column(name="hier_occurrence_id", type="integer", nullable=false, options={"unsigned"=true})
     */
    private $hierOccurrenceId;
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="parent_id", referencedColumnName="occurrence_id")
     * })
     */
    private $parent;
    ...
    public function getHierOccurrenceId(): ?int
    {
        return $this->hierOccurrenceId;
    }

    public function setHierOccurrenceId(int $hierOccurrenceId): self
    {
        $this->hierOccurrenceId = $hierOccurrenceId;
