...
/**
 * CaLoansXObjectRepresentations
 *
 * @ORM\Table(name="ca_loans_x_object_representations", uniqueConstraints={@ORM\UniqueConstraint(name="u_all", columns={"type_id", "representation_id", "loan_id", "sdatetime", "edatetime"})}, indexes={@ORM\Index(name="i_representation_id", columns={"representation_id"}), @ORM\Index(name="i_label_left_id", columns={"label_left_id"}), @ORM\Index(name="i_loan_id", columns={"loan_id"}), @ORM\Index(name="i_label_right_id", columns={"label_right_id"}), @ORM\Index(name="i_type_id", columns={"type_id"})})
 * @ORM\Entity
 */
class CaLoansXObjectRepresentations
{
    /**
     * @var int
     *
