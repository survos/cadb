...
/**
 * CaObjectRepresentationsXOccurrences
 *
 * @ORM\Table(name="ca_object_representations_x_occurrences", uniqueConstraints={@ORM\UniqueConstraint(name="u_all", columns={"type_id", "representation_id", "occurrence_id", "sdatetime", "edatetime"})}, indexes={@ORM\Index(name="i_representation_id", columns={"representation_id"}), @ORM\Index(name="i_label_left_id", columns={"label_left_id"}), @ORM\Index(name="i_occurrence_id", columns={"occurrence_id"}), @ORM\Index(name="i_label_right_id", columns={"label_right_id"}), @ORM\Index(name="i_type_id", columns={"type_id"})})
 * @ORM\Entity
 */
class CaObjectRepresentationsXOccurrences
{
    /**
     * @var int
     *
