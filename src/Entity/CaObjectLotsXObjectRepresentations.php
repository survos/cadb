...
/**
 * CaObjectLotsXObjectRepresentations
 *
 * @ORM\Table(name="ca_object_lots_x_object_representations", uniqueConstraints={@ORM\UniqueConstraint(name="u_all", columns={"type_id", "representation_id", "lot_id", "sdatetime", "edatetime"})}, indexes={@ORM\Index(name="i_representation_id", columns={"representation_id"}), @ORM\Index(name="i_label_left_id", columns={"label_left_id"}), @ORM\Index(name="i_lot_id", columns={"lot_id"}), @ORM\Index(name="i_label_right_id", columns={"label_right_id"}), @ORM\Index(name="i_type_id", columns={"type_id"})})
 * @ORM\Entity
 */
class CaObjectLotsXObjectRepresentations
{
    /**
     * @var int
     *
