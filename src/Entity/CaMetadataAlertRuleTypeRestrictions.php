...
/**
 * CaMetadataAlertRuleTypeRestrictions
 *
 * @ORM\Table(name="ca_metadata_alert_rule_type_restrictions", indexes={@ORM\Index(name="i_rule_id", columns={"rule_id"}), @ORM\Index(name="i_type_id", columns={"type_id"})})
 * @ORM\Entity
 */
class CaMetadataAlertRuleTypeRestrictions
{
    /**
     * @var int
     *
