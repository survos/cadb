 ...
 * CaLoans
 *
 * @ORM\Table(name="ca_loans", indexes={@ORM\Index(name="i_source_id", columns={"source_id"}), @ORM\Index(name="idno_sort", columns={"idno_sort"}), @ORM\Index(name="hier_loan_id", columns={"hier_loan_id"}), @ORM\Index(name="i_submission_group_id", columns={"submission_group_id"}), @ORM\Index(name="i_parent_id", columns={"parent_id"}), @ORM\Index(name="i_locale_id", columns={"locale_id"}), @ORM\Index(name="hier_left", columns={"hier_left"}), @ORM\Index(name="i_view_count", columns={"view_count"}), @ORM\Index(name="i_submission_status_id", columns={"submission_status_id"}), @ORM\Index(name="i_type_id", columns={"type_id"}), @ORM\Index(name="idno", columns={"idno"}), @ORM\Index(name="hier_right", columns={"hier_right"}), @ORM\Index(name="i_loan_filter", columns={"loan_id", "deleted", "access"}), @ORM\Index(name="i_submission_user_id", columns={"submission_user_id"}), @ORM\Index(name="i_submission_via_form", columns={"submission_via_form"})})
 * @ORM\Entity
 */
class CaLoans
{
     ...
     * @var int
     *
     * @ORM\Column(name="loan_id", type="integer", nullable=false, options={"unsigned"=true})
     * @ORM\Id
     ...
     * @var int
     *
     * @ORM\Column(name="hier_loan_id", type="integer", nullable=false, options={"unsigned"=true})
     */
    private $hierLoanId;
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="parent_id", referencedColumnName="loan_id")
     * })
     */
    private $parent;
    ...
    public function getHierLoanId(): ?int
    {
        return $this->hierLoanId;
    }

    public function setHierLoanId(int $hierLoanId): self
    {
        $this->hierLoanId = $hierLoanId;
