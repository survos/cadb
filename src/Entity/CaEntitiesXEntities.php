 ...
 * CaEntitiesXEntities
 *
 * @ORM\Table(name="ca_entities_x_entities", uniqueConstraints={@ORM\UniqueConstraint(name="u_all", columns={"entity_left_id", "entity_right_id", "type_id", "sdatetime", "edatetime"})}, indexes={@ORM\Index(name="i_entity_left_id", columns={"entity_left_id"}), @ORM\Index(name="i_label_left_id", columns={"label_left_id"}), @ORM\Index(name="i_entity_right_id", columns={"entity_right_id"}), @ORM\Index(name="i_label_right_id", columns={"label_right_id"}), @ORM\Index(name="i_type_id", columns={"type_id"})})
 * @ORM\Entity
 */
class CaEntitiesXEntities
{
    /**
     * @var int
     *
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="entity_left_id", referencedColumnName="entity_id")
     * })
     */
    private $entityLeft;
     ...
     * @ORM\ManyToOne(targetEntity="CaEntities")
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="entity_right_id", referencedColumnName="entity_id")
     * })
     */
    private $entityRight;
    ...
    public function getEntityLeft(): ?CaEntities
    {
        return $this->entityLeft;
    }

    public function setEntityLeft(?CaEntities $entityLeft): self
    {
    ...
    public function getEntityRight(): ?CaEntities
    {
        return $this->entityRight;
    }

    public function setEntityRight(?CaEntities $entityRight): self
    {
