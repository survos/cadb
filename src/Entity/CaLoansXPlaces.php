 ...
 * CaLoansXPlaces
 *
 * @ORM\Table(name="ca_loans_x_places", uniqueConstraints={@ORM\UniqueConstraint(name="u_all", columns={"loan_id", "place_id", "type_id", "sdatetime", "edatetime"})}, indexes={@ORM\Index(name="i_loan_id", columns={"loan_id"}), @ORM\Index(name="i_label_left_id", columns={"label_left_id"}), @ORM\Index(name="i_place_id", columns={"place_id"}), @ORM\Index(name="i_label_right_id", columns={"label_right_id"}), @ORM\Index(name="i_type_id", columns={"type_id"})})
 * @ORM\Entity
 */
class CaLoansXPlaces
{
    /**
     * @var int
     *
