 ...
 * CaObjectLotLabels
 *
 * @ORM\Table(name="ca_object_lot_labels", uniqueConstraints={@ORM\UniqueConstraint(name="u_all", columns={"lot_id", "name", "type_id", "locale_id"})}, indexes={@ORM\Index(name="i_lot_id", columns={"lot_id"}), @ORM\Index(name="i_locale_id", columns={"locale_id"}), @ORM\Index(name="i_name_sort", columns={"name_sort"}), @ORM\Index(name="i_name", columns={"name"}), @ORM\Index(name="i_type_id", columns={"type_id"})})
 * @ORM\Entity
 */
class CaObjectLotLabels
{
    /**
     * @var int
     *
