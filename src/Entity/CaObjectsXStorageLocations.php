...
/**
 * CaObjectsXStorageLocations
 *
 * @ORM\Table(name="ca_objects_x_storage_locations", uniqueConstraints={@ORM\UniqueConstraint(name="u_all", columns={"object_id", "type_id", "sdatetime", "edatetime", "location_id"})}, indexes={@ORM\Index(name="i_object_id", columns={"object_id"}), @ORM\Index(name="i_label_left_id", columns={"label_left_id"}), @ORM\Index(name="i_location_id", columns={"location_id"}), @ORM\Index(name="i_label_right_id", columns={"label_right_id"}), @ORM\Index(name="i_type_id", columns={"type_id"})})
 * @ORM\Entity
 */
class CaObjectsXStorageLocations
{
    /**
     * @var int
     *
