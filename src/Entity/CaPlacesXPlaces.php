 ...
 * CaPlacesXPlaces
 *
 * @ORM\Table(name="ca_places_x_places", uniqueConstraints={@ORM\UniqueConstraint(name="u_all", columns={"place_left_id", "place_right_id", "type_id", "sdatetime", "edatetime"})}, indexes={@ORM\Index(name="i_place_left_id", columns={"place_left_id"}), @ORM\Index(name="i_label_left_id", columns={"label_left_id"}), @ORM\Index(name="i_place_right_id", columns={"place_right_id"}), @ORM\Index(name="i_label_right_id", columns={"label_right_id"}), @ORM\Index(name="i_type_id", columns={"type_id"})})
 * @ORM\Entity
 */
class CaPlacesXPlaces
{
    /**
     * @var int
     *
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="place_left_id", referencedColumnName="place_id")
     * })
     */
    private $placeLeft;
     ...
     * @ORM\ManyToOne(targetEntity="CaPlaces")
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="place_right_id", referencedColumnName="place_id")
     * })
     */
    private $placeRight;
    ...
    public function getPlaceLeft(): ?CaPlaces
    {
        return $this->placeLeft;
    }

    public function setPlaceLeft(?CaPlaces $placeLeft): self
    {
    ...
    public function getPlaceRight(): ?CaPlaces
    {
        return $this->placeRight;
    }

    public function setPlaceRight(?CaPlaces $placeRight): self
    {
