 ...
 * CaObjectLotsXPlaces
 *
 * @ORM\Table(name="ca_object_lots_x_places", uniqueConstraints={@ORM\UniqueConstraint(name="u_all", columns={"place_id", "type_id", "sdatetime", "edatetime"})}, indexes={@ORM\Index(name="i_place_id", columns={"place_id"}), @ORM\Index(name="i_label_right_id", columns={"label_right_id"}), @ORM\Index(name="i_type_id", columns={"type_id"}), @ORM\Index(name="i_lot_id", columns={"lot_id"}), @ORM\Index(name="i_label_left_id", columns={"label_left_id"})})
 * @ORM\Entity
 */
class CaObjectLotsXPlaces
{
    /**
     * @var int
     *
