...
/**
 * CaRepresentationAnnotations
 *
 * @ORM\Table(name="ca_representation_annotations", indexes={@ORM\Index(name="i_user_id", columns={"user_id"}), @ORM\Index(name="i_representation_id", columns={"representation_id"}), @ORM\Index(name="i_view_count", columns={"view_count"}), @ORM\Index(name="i_locale_id", columns={"locale_id"})})
 * @ORM\Entity
 */
class CaRepresentationAnnotations
{
    /**
     * @var int
     *
