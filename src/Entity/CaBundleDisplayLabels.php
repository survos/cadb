...
/**
 * CaBundleDisplayLabels
 *
 * @ORM\Table(name="ca_bundle_display_labels", indexes={@ORM\Index(name="i_display_id", columns={"display_id"}), @ORM\Index(name="i_locale_id", columns={"locale_id"})})
 * @ORM\Entity
 */
class CaBundleDisplayLabels
{
    /**
     * @var int
     *
     ...
     * @var int|null
     *
     * @ORM\Column(name="display_id", type="integer", nullable=true, options={"default"="NULL","unsigned"=true})
     */
