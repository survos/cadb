...
/**
 * CaObjectRepresentationLabels
 *
 * @ORM\Table(name="ca_object_representation_labels", indexes={@ORM\Index(name="fk_ca_object_representation_labels_representation_id", columns={"representation_id"}), @ORM\Index(name="fk_ca_object_representation_labels_type_id", columns={"type_id"}), @ORM\Index(name="fk_ca_object_representation_labels_locale_id", columns={"locale_id"})})
 * @ORM\Entity
 */
class CaObjectRepresentationLabels
{
    /**
     * @var int
     *
