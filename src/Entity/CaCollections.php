 ...
 * CaCollections
 *
 * @ORM\Table(name="ca_collections", indexes={@ORM\Index(name="i_idno", columns={"idno"}), @ORM\Index(name="i_source_id", columns={"source_id"}), @ORM\Index(name="i_hier_right", columns={"hier_right"}), @ORM\Index(name="i_collection_filter", columns={"collection_id", "deleted", "access"}), @ORM\Index(name="i_submission_user_id", columns={"submission_user_id"}), @ORM\Index(name="i_submission_via_form", columns={"submission_via_form"}), @ORM\Index(name="i_parent_id", columns={"parent_id"}), @ORM\Index(name="i_idno_sort", columns={"idno_sort"}), @ORM\Index(name="i_hier_collection_id", columns={"hier_collection_id"}), @ORM\Index(name="i_acl_inherit_from_parent", columns={"acl_inherit_from_parent"}), @ORM\Index(name="i_submission_group_id", columns={"submission_group_id"}), @ORM\Index(name="i_type_id", columns={"type_id"}), @ORM\Index(name="i_locale_id", columns={"locale_id"}), @ORM\Index(name="i_hier_left", columns={"hier_left"}), @ORM\Index(name="i_view_count", columns={"view_count"}), @ORM\Index(name="i_submission_status_id", columns={"submission_status_id"})})
 * @ORM\Entity
 */
class CaCollections
{
     ...
     * @var int
     *
     * @ORM\Column(name="hier_collection_id", type="integer", nullable=false, options={"unsigned"=true})
     */
    private $hierCollectionId;
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="parent_id", referencedColumnName="collection_id")
     * })
     */
    private $parent;
    ...
    public function getHierCollectionId(): ?int
    {
        return $this->hierCollectionId;
    }

    public function setHierCollectionId(int $hierCollectionId): self
    {
        $this->hierCollectionId = $hierCollectionId;
