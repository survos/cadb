...
/**
 * CaMetadataDictionaryEntryLabels
 *
 * @ORM\Table(name="ca_metadata_dictionary_entry_labels", indexes={@ORM\Index(name="i_entry_id", columns={"entry_id"}), @ORM\Index(name="i_locale_id", columns={"locale_id"})})
 * @ORM\Entity
 */
class CaMetadataDictionaryEntryLabels
{
    /**
     * @var int
     *
     ...
     * @var int|null
     *
     * @ORM\Column(name="entry_id", type="integer", nullable=true, options={"default"="NULL","unsigned"=true})
     */
