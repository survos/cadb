 ...
 * CaOccurrenceLabels
 *
 * @ORM\Table(name="ca_occurrence_labels", uniqueConstraints={@ORM\UniqueConstraint(name="u_all", columns={"occurrence_id", "name", "type_id", "locale_id"})}, indexes={@ORM\Index(name="i_name", columns={"name"}), @ORM\Index(name="i_type_id", columns={"type_id"}), @ORM\Index(name="i_locale_id", columns={"locale_id"}), @ORM\Index(name="i_occurrence_id", columns={"occurrence_id"}), @ORM\Index(name="i_name_sort", columns={"name_sort"})})
 * @ORM\Entity
 */
class CaOccurrenceLabels
{
    /**
     * @var int
     *
