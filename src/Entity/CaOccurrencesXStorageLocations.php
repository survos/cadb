...
/**
 * CaOccurrencesXStorageLocations
 *
 * @ORM\Table(name="ca_occurrences_x_storage_locations", uniqueConstraints={@ORM\UniqueConstraint(name="u_all", columns={"occurrence_id", "location_id", "type_id", "sdatetime", "edatetime"})}, indexes={@ORM\Index(name="i_occurrence_id", columns={"occurrence_id"}), @ORM\Index(name="i_label_left_id", columns={"label_left_id"}), @ORM\Index(name="i_location_id", columns={"location_id"}), @ORM\Index(name="i_label_right_id", columns={"label_right_id"}), @ORM\Index(name="i_type_id", columns={"type_id"})})
 * @ORM\Entity
 */
class CaOccurrencesXStorageLocations
{
    /**
     * @var int
     *
